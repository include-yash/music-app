...
export default function SignupFormDemo() {
  ...
  // State variable for loading and error handling
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Send POST request to the server on localhost:1000
      const response = await axios.post("http://localhost:1000/api/v1/user/signup", formData);
      
      // Log the response (you may want to redirect or show a success message)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black mt-8 mb-8">
